...
#[derive(Accounts)]
pub struct AProjectDistribution<'info> {
    #[account(mut)]
    ...
    #[account(
        ...
        constraint= user_opos_ata.amount >= 45000000000000 @ MyError::NotEnoughTokenToMint
    )]
...
impl<'info> AProjectDistribution<'info> {
