...
pub struct MintProfileByAdminInput {
    ...
    symbol: String,
    uri: String,
    parent_mint_lineage: LineageInfo,
    parent_mint: Pubkey,
}
...
pub fn mint_profile_by_admin(
    ...
    // let mut nft_creators = Vec::<Creator>::new();
    {
        ...
        profile_state.lineage.grand_parent = input.parent_mint_lineage.parent;
        profile_state.lineage.great_grand_parent = input.parent_mint_lineage.grand_parent;
        profile_state.lineage.uncle_psy = input.parent_mint_lineage.uncle_psy;
        profile_state.lineage.generation = input.parent_mint_lineage.generation + 1;
        // PERF: not work for now because is currently on testing
